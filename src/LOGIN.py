...
def signup():
    ...
    signup_window.title("Image Steganograpy by group - 07") #title for the window
    #create 3 Labels
    ...
    l4 = Label(signup_window,text="Confirm Password: ",font="times 20")
    ...
    password_text = StringVar()
    e4 = Entry(signup_window,textvariable=password_text,show='*')
...
window.title("Image Steganograpy by group - 07")
#adding the label "Register Here"
label1 = Label(window, text="Welcome To Image Steganograpy",font="times 20",padx=20,pady=20)
